...
var coinChange = function(coins, amount) {
	...
	for (let coin of coins) {
		//comparing tables, i represents the amount
		for (let i = 0; i < table.length; i++) {
			if (coin <= i) {
				//idx will get the current index
				let idx = i - coin;
	...
	//if it equals infinity, then it is not found, else return table
